...
img_arr = imageio.imread('../face_DCGAN/face_data/img/data/train/000001.jpg')
print(img_arr.shape)
...
data = torchvision.datasets.ImageFolder('../face_DCGAN/face_data/img', transform = transform)
