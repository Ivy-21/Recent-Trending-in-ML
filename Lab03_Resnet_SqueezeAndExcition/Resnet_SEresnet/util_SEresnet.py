...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, weights_name='weight_save', is_inception=False):
    print('====================== New Run =======================',file=open("outputSE.txt", "a"))
    '''
    ...
    for epoch in range(num_epochs):
        ...
        print('Epoch {}/{}'.format(epoch, num_epochs - 1), file=open("outputSE.txt", "a"))
        print('-' * 10, file=open("outputSE.txt", "a"))
        ...
        for phase in ['train', 'val']:
            ...
            print('{} Loss: {:.4f} Acc: {:.4f}'.format(phase, epoch_loss, epoch_acc), file=open("outputSE.txt", "a"))
            print(f"Epoch time taken: {elapsed_epoch}", file=open("outputSE.txt", "a"))
